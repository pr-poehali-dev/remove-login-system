          ...
          <CardContent className="space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                ...
                <li>Информация о действиях на Сайте (журналы посещений, просмотренные страницы)</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                ...
                <li>Информирование о новых материалах, русификаторах и обновлениях</li>
            ...
            <section>
              ...
              <p>
                Обработка персональных данных осуществляется с соблюдением принципов, установленных законодательством Российской Федерации. Оператор принимает необходимые организационные и технические меры для защиты персональных данных от неправомерного доступа, уничтожения, изменения, блокирования, копирования, распространения.
              </p>
              <p className="mt-2">
              ...
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                ...
                <li>Передачи платёжным системам для обработки донатов</li>
                <li>Передачи техническим партнёрам для обеспечения работы Сайта (хостинг-провайдеры)</li>
              </ul>
            </section>
